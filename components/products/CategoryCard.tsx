  ...
  return (
    <Link
      ...
      className={cn(
        ...
        // Variantes solo aplican en pantallas medianas y grandes
    ...
    >
      ...
      <div
        className={cn(
          ...
          // En móvil, todas las cards tienen el mismo aspect ratio
          "aspect-4/3",
          // En tablet y desktop, aplicamos las variantes
          variant === "default" && "md:aspect-4/5",
          variant === "large" && "md:aspect-4/9",
      ...
      >
        ...
        <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end">
          <div className="space-y-2 md:space-y-3">
            <div className="space-y-1">
              <h3 className="text-white text-2xl md:text-3xl font-serif font-bold group-hover:underline decoration-2 underline-offset-4 transition-elegant">
                {category.name}
              </h3>
        ...
        {/* Hover Effect Border */}
        <div className="absolute inset-0 border-2 md:border-4 border-white opacity-0 group-hover:opacity-100 transition-elegant" />
      </div>
    </Link>
  );
}
